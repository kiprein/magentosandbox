...
class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action {
	 ...
	 *
	 * This method should be overwritten correctly in the Js Customer Account controller.  However since I have still not
	 * figured out how spam users are created I'm throwing this here to truly make sure nothing can get in.
	 *
	 * Jon 8/14/17
	 */
...
//		$this->_redirectError($errUrl);
	...
	//////////////////// End method for custom Registerationk
		...
		if ($this->getRequest()->isPost()) {
			...
			try {
				...
				$this->_getSession()->setCustomer($customer)
					->addSuccess($this->__('The password has been successfully updated.'));
