...
class Mage_CatalogSearch_Block_Result extends Mage_Core_Block_Template
{
    ...
    protected function _getProductCollection()
    {
		...
		$search_txt=trim($_REQUEST['q']);
           // $this->_productCollection = $this->getListBlock()->getLoadedProductCollection();
		//$this->_productCollection = Mage::getSingleton('catalogsearch/layer')
										//->getProductCollection()
									//	->addAttributeToFilter('name', array('like' => '% '.$_REQUEST['q'].' %'));
		$this->_productCollection = Mage::getModel('catalog/product')->getCollection()
									->addAttributeToFilter('name', array('like' => '%'.$search_txt.'%'))->load();
							
		/*$this->_productCollection = Mage::getModel('catalogsearch/layer')
                             ->getCollection()
                           	 ->addAttributeToFilter('name', array('like' => '% '.$_REQUEST['q'].' %'));*/ //;
			/////////////////
