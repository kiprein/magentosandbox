    ...
    extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        if (is_dir($old_upload_folder)) {
            try {
                ...
                Mage::log('017', null, 'mgwlog.log', true);
            }
        }
    ...
    public function editAction()
    {
        ...
        if ($webformsModel->getId() && $webformsModel->getAdminPermission() != 'allow') {
            ...
            Mage::log('018', null, 'mgwlog.log', true);
        ...
        if ($webformsModel->getId() || $webformsId == 0) {
            ...
            Mage::log('019', null, 'mgwlog.log', true);
            $this->_redirect('*/*/');
        }
    }
    ...
    public function saveAction()
    {
        if ($this->getRequest()->getPost()) {
            try {
                ...
                Mage::log('020 ' . $e->getMessage(), null, 'mgwlog.log', true);
    ...
    public function deleteAction()
    {
        if ($this->getRequest()->getParam('id') > 0) {
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
                Mage::log('021 ' . $e->getMessage(), null, 'mgwlog.log', true);
    ...
    public function duplicateAction()
    {
        ...
        if ($form->getId()) {
            ...
            Mage::log('022', null, 'mgwlog.log', true);
            $this->_redirect('*/*/edit', array('id' => $this->getRequest()->getParam('id')));
        }
    }
