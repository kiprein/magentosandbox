...
//        }
		...
		///new code start here
		$fieldset->addField('ara_asi','text', array(
			'name'      => 'ara_asi',
			'label'=>'ARA, ASI, PPAI or SAGE'		
		));
		
		$fieldset->addField('where_did_you','text', array(
			'name'      => 'where_did_you',
			'label'=>'Where did you hear about us'		
		));
		
		$fieldset->addField('other_where_did_you','text', array(
			'name'      => 'other_where_did_you',
			'label'=>''		
		));
