    ...
    extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        if (Mage::registry('webform')->getId()) {
            ...
            Mage::log('008', null, 'mgwlog.log', true);
    ...
    public function saveAction()
    {
        if ($this->getRequest()->getPost()) {
            try {
                ...
                Mage::log('009 ' . $e->getMessage(), null, 'mgwlog.log', true);
        ...
        Mage::log('010', null, 'mgwlog.log', true);
        $this->_redirect('*/webforms_webforms/index');
    }
    ...
    public function deleteAction()
    {
        if ($this->getRequest()->getParam('id') > 0) {
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
                Mage::log('011 ' . $e->getMessage(), null, 'mgwlog.log', true);
                $this->_redirect('*/*/edit', array('id' => $this->getRequest()->getParam('id')));
                return;
            }
        }
        Mage::getSingleton('adminhtml/session')->addError(Mage::helper('webforms')->__('Unexpected error'));
        Mage::log('012', null, 'mgwlog.log', true);
        $this->_redirect('*/webforms_webforms/index');
    }
