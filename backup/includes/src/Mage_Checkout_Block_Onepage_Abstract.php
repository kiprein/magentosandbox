...
/* */
    public function getAddressesHtmlSelect($type)
    {
        if ($this->isCustomerLoggedIn()) {
            ...
            $select = $this->getLayout()->createBlock('core/html_select')
                ...
                //->setExtraParams('onchange="'.$type.'.newAddress(!this.value)"') //MGW 9/10/19
                ->setValue($addressId)
                ->setOptions($options);

            /**
             * MGW 9/10/19 Removed option to select "New Address" from dropdown. It didn't seem
             * to do anything besides allow for the form to show up anyhow. Form is now default
    ...
    {
        return array('login', 'shipping', 'shipping_method', 'billing', 'payment', 'review'); //#mgwAddingStep
    }
