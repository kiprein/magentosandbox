    ...
    protected function _prepareFieldsetGeneral()
    {
        ...
        if ($this->isDecimal()) {
            ...
            $fldSet->addField('sort_by', 'select', array(
                ...
                'values'    => array(
                    array(
                        'value' => Amasty_Shopby_Model_Filter::SORT_BY_POS,
                        'label' => $this->__('Position')
                    ),
                    array(
                        'value' => Amasty_Shopby_Model_Filter::SORT_BY_NAME,
                        'label' => $this->__('Name')
                    ),
                    array(
                        'value' => Amasty_Shopby_Model_Filter::SORT_BY_QTY,
        ...
        $fldSet->addField('use_mapping', 'select', array(
