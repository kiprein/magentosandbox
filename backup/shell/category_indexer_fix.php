...
class Category_Indexer_Fix extends Mage_Shell_Abstract {
...
INNER JOIN catalog_category_entity AS b on a.entity_id = b.entity_id WHERE attribute_id = 41 AND b.entity_id IN ($categoriesString)" );
				...
				$updatePosition = "UPDATE catalog_category_product_index SET position = '$position' WHERE product_id = '$productId' AND category_id = 4";
...
$shell = new Category_Indexer_Fix();
